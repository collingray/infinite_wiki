...
card:
  title: |-
    Luigi Galleani
  image: |-
    https://upload.wikimedia.org/wikipedia/commons/6/69/Luigi_Gallean2.jpg
  caption: |-
    1906 <a>police photograph</a> of Galleani.
  Born: |-
    August 12, 1861, <a>Vercelli</a>, <a>Piedmont</a>, Kingdom of Italy
  Died: |-
    November 4, 1931 (aged 70), Caprigliola, Aulla, Tuscany, Kingdom of Italy
  Notable_work:
    - |-
...
content:
  summary: |-
    Luigi Galleani (Italian: [luˈiːdʒi ɡalleˈaːni]; August 12, 1861 – November 4, 1931) was an Italian <a>insurrectionary anarchist</a> best known for his advocacy of "<a>propaganda of the deed</a>", a strategy of political assassinations and violent attacks.
...
card:
  title: |-
    The City of New New York
  image: |-
    https://upload.wikimedia.org/wikipedia/commons/1/1f/Futuristic_city.jpg
  caption: |-
    Photo of the futuristic city of New New York, taken in the year 2934
  Population: |-
  ...
  Established: |-
    January 1, 2571
  Mayor: |-
    <a>Rudy Giuliani XIII</a>
  Nickname: |-
    The City That Never Sleeps
content:
  summary: |-
    The City of New New York is the capitol city of the <a>United Earth Federation</a>. Established in the year 2543, it is known for its futuristic architecture, advanced technology, and vibrant cultural scene. With a population of over 140 million residents, the city spans an area of 3511 square miles, making it one of the largest and most populous cities in the federation. It's slogan is "The City That Never Sleeps", a nod to the bustling nightlife and round-the-clock activity that characterizes the metropolis.
  History:
    Founding: |-
      The City of New New York was founded on January 1, 2571, by a group of architects and urban planners, wishing to rebuild the fabled city of Old New York, destroyed in the <a>Second Rebellion of the Skies</a>. They set out to create a utopian city that would serve as a beacon of progress and innovation for the entire federation. The city quickly grew into a thriving hub of commerce, art, and entertainment.
      Five years after breaking ground, the city was officially declared the capitol of the United Earth Federation, solidifying its status as a center of power and influence in the galaxy.
    Technological Advancements: |-
      New New York is at the forefront of technological innovation, with flying cars, teleportation devices, and automated robots being a common sight in the city. The skyline is dotted with towering skyscrapers made of glass and steel, showcasing the architectural prowess of the city's designers. 
      The city is also home to the <a>Galactic Tower</a>, the tallest building in the federation, which serves as a symbol of the city's ambition and progress.
  Culture:
    Arts and Entertainment: |-
      New New York City has long been known as a cultural melting pot, with art galleries, theaters, and music venues showcasing a diverse array of talent from across the federation. 
      The annual <a>New New York Arts Festival</a> draws millions of visitors from far and wide to celebrate creativity and expression.
    Cuisine: |-
      New New York is renowned for its eclectic culinary scene, featuring a mix of traditional Earth cuisine and intergalactic flavors. Visitors can enjoy everything from classic pizza and burgers to alien "delicacies" from distant planets.
  Governance:
    Mayor Rudy Giuliani XIII: |-
      Mayor Rudy Giuliani XIII has been in office since 2632, having declared himself "Grand Mayor for Life" in 2641, which he was able to enact despite its unconstitutionality as the populace was distracted by the ongoing <a>Rat Uprising of 2640</a>.
      Known for his tough stance on crime and corruption, he has implemented strict laws and regulations to maintain order in the bustling metropolis. Despite his controversial policies, he remains a popular figure among the city's residents.
    Redistricting: |-
      In 2930, Mayor Giuliani XIII enacted a controversial plan to terraform and redistrict the city, rearranging the five historic boroughs into a single mega-district known as "Longhattan". The move was met with mixed reactions from the populace, with some praising the mayor's vision and others decrying the loss of their borough's unique identity.
      Despite the backlash, the Mayor went forward with the plan, even suggesting that he would like to see it taken further, claiming that "This is just the beginning, I won't stop until we reach Florida!"
  Economy:
    Industries: |-
      New New York is a hub for technology, finance, entertainment, and <a>intergalactic trade</a>. The city's economy is booming, with companies from around the federation setting up headquarters in the futuristic skyline of the metropolis.
    Tourism: |-
      Tourism plays a significant role in the economy of New New York, with visitors flocking to the city to experience its vibrant culture, cutting-edge technology, and unique attractions. From virtual reality theme parks to underwater museums, there is something for everyone in the city.
  Notable Landmarks:
    - |-
      <a>Galactic Tower</a>
    - |-
...
"""},
    ...
    {"role": "assistant", "content": """title: |-
    Richard Nixon's 2814 Presidential Campaign
card:
  title: |-
    Richard Nixon's 2814 Presidential Campaign
  image: |-
    https://upload.wikimedia.org/wikipedia/commons/4/4f/Richard_Nixon_presidential_portrait.jpg
  caption: |-
    Official portrait of President Richard Nixon, 2814
  Candidate: |-
    <a>Richard Nixon</a>
  Running Mate: |-
...
content:
  summary: |-
    Richard Nixon's 2814 Presidential Campaign was a historic event in the history of the United States, marking the return of the former president to the political arena. Running as the candidate of the Neo Republican Party, Nixon sought to reclaim the presidency after a 700-year absence. 
    His running mate, John F. Kennedy Jr. Jr. Jr. Jr., was a popular figure in his own right, having been responsible for negotiating the <a>Galactic Peace Accords</a> with the <a>Andromedan Empire</a>.
  Background:
    Return to Politics: |-
      After being cryogenically frozen for over seven centuries, Richard Nixon was revived in the year 2814 by a team of scientists working for the Neo Republican Party. Eager to make his mark on history once again, Nixon announced his intention to run for president, citing the need for strong leadership in a time of intergalactic turmoil.
    Selection of Running Mate: |-
      John F. Kennedy Jr. Jr. Jr. Jr. was chosen as Nixon's running mate due to his popularity among voters and his expertise in  
      Together, Nixon and Kennedy formed a formidable team, promising to bring stability and prosperity to the galaxy.
      Spiro Agnew XI was also considered for the position, but was ultimately passed over in favor of Kennedy.
  Campaign Platform:
    Economic Reform: |-
      Nixon's platform focused on revitalizing the economy of the United States and its interstellar territories, promising to create new jobs and stimulate growth through economic reforms and <a>galactic terraforming</a> projects. 
      He also pledged to repeal child labor laws and increase the retirement age to 200.
    Foreign Policy: |-
      Kennedy's expertise in quantum diplomacy played a key role in shaping the campaign's foreign policy platform, which emphasized peaceful relations with alien civilizations and cooperation on issues of mutual interest.
    Technology: |-
      Nixon's campaign pledged to invest in cutting-edge technologies, such as <a>hyperspace travel</a> and <a>terraforming</a>, to ensure the continued prosperity of the United States and its allies.
  Controversies:
    Time Travel Scandal: |-
      During the campaign, rumors surfaced that Nixon had used a time machine to alter the course of history and secure his victory. Nixon staunchly denied the claims, famously claiming "I am not a time traveler!". 
      Although these allegations were never proven, they cast a shadow over the campaign and raised questions about the integrity of the electoral process.
    Alien Endorsements: |-
      Nixon's campaign was dogged by allegations of receiving endorsements from extraterrestrial beings, leading to accusations of foreign interference in the election. Despite these claims, Nixon denied any wrongdoing and continued to campaign vigorously until election day. 
      He would later describe that the allegations were "entirely accurate", and that the aliens had been "Damn good creatures! The best!"
  Legacy:
    Victory: |-
      In a stunning upset, Nixon and Kennedy won the 2814 presidential election by a narrow margin, defeating the incumbent president, <a>Barack Obama XIV</a>. Their victory marked a new era in American politics, ushering in a period of unprecedented prosperity and cooperation with alien civilizations.
    Nixon's Presidency: |-
      As president, Nixon worked to implement his campaign promises, overseeing the construction of the <a>Interstellar Trade Center</a> and the signing of the <a>Galactic Peace Accords</a>. 
      His administration was marked by a spirit of optimism and innovation, setting the stage for a new era of interstellar cooperation and progress.
  See Also:
    - |-
      <a>Neo Republican Party</a>
    - |-
